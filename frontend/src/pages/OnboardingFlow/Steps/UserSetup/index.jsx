    ...
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border rounded-lg border-white/20 p-8 items-center gap-y-4 w-full max-w-[600px]">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
          ...
          >
            <div className="text-center text-sm font-bold">只有我</div>
          </button>
          <button
          ...
          >
            <div className="text-center text-sm font-bold">我的团队</div>
          </button>
        </div>
      </div>
      {selectedOption === "just_me" && (
    ...
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border rounded-lg border-white/20 p-8 items-center gap-y-4 w-full max-w-[600px]">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
          ...
          >
            <div className="text-center text-sm font-bold">需要</div>
          </button>
          <button
            onClick={handleNo}
            className={`${
          ...
          >
            <div className="text-center text-sm font-bold">不需要</div>
          </button>
        </div>
        {enablePassword && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex w-full justify-between items-center px-6 py-4 space-x-6 border-t rounded-b border-gray-500/50">
          <div className=" text-white text-opacity-80 text-xs font-base">
            默认情况下，您将是唯一的管理员.
            一旦登录完成，您可以创建和邀请其他人成为用户或管理员.
            不要丢失你的密码，因为只有管理员可以重置密码.
          </div>
        </div>
        <button
          type="submit"
